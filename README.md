...
<p align="center">
  <a href="https://labex.io/courses/mastering-nmap-host-discovery-port-scanning">
    <img src="https://course-cover.labex.io/mastering-nmap-host-discovery-port-scanning.png" alt="Nmap Host Discovery &amp; Port Scanning">
  </a>
</p>
...
[Start Course on LabEx](https://labex.io/courses/mastering-nmap-host-discovery-port-scanning)

## Exercises

|   Index | Name                        | Difficulty   | Practice                                                                                                                                                      |
|---------|-----------------------------|--------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       1 | Host Discovery Strategies   | Beginner     | <a target='_blank' href='https://labex.io/labs/linux-host-discovery-strategies-656135?course=mastering-nmap-host-discovery-port-scanning'>Start Lab</a>       |
|       2 | TCP and UDP Port Scanning   | Beginner     | <a target='_blank' href='https://labex.io/labs/linux-tcp-and-udp-port-scanning-656138?course=mastering-nmap-host-discovery-port-scanning'>Start Lab</a>       |
|       3 | Optimizing Scan Performance | Beginner     | <a target='_blank' href='https://labex.io/labs/linux-optimizing-scan-performance-656137?course=mastering-nmap-host-discovery-port-scanning'>Start Lab</a>     |
|       4 | Nmap Output Formats         | Beginner     | <a target='_blank' href='https://labex.io/labs/linux-nmap-output-formats-656136?course=mastering-nmap-host-discovery-port-scanning'>Start Lab</a>             |
|       5 | Network Mapping Challenge   | Intermediate | <a target='_blank' href='https://labex.io/labs/linux-network-mapping-challenge-656134?course=mastering-nmap-host-discovery-port-scanning'>Start Challenge</a> |
